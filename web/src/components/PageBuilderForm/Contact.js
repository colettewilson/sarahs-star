...
const ContactForm = () => {
  ...
  return (
    <form className={styles.form} name="contact" method="post" action="/" data-netlify="true" netlify-honeypot="bot-field" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={styles.formField}>
        <label className={styles.formLabel} id="message" htmlFor="message">Message*</label>
